...
var http = require('http'); http.createServer(function (req, res) { res.write("TEC Is Alive"); res.end(); }).listen(8080); 
...
const { MessageEmbed } = require('discord.js')
  ...
  client.on('interactionCreate', async interaction => {
    ...
    if(funny === 'sixth') {
        ...
        .setDescription("`serverinfo, servericon, avatar, emojilist, firstmsg, membercount, list-roles`")
    ...
    if(funny === 'first') {
        ...
        .setAuthor("Information Commands")        .setColor(client.embedColor)
        .setFooter("Feel the Quality of TEC Music")   
...
if(funny === 'second') {
        ...
        .setThumbnail(client.user.displayAvatarURL()) 
        .setDescription("`autoplay, clearqueue, join, leave, loop, nowplaying, pause, play, volume, destroy, queue, resume, shuffle, skip, stop`")
...
if(funny === 'fifth') {
  ...
  if(funny === 'sixth') {
        const embed6 = new MessageEmbed()
        .setThumbnail(client.user.displayAvatarURL())
        .setDescription("`avatar, server-icon, serverinfo, membercount, firstmsg, list-roles, list-emojis`")
        .setAuthor("Utility Commands")
        .setColor(client.embedColor)
        .setFooter("Feel the Quality of TEC Music")
  interaction.reply({ embeds: [embed6], ephemeral: true })
...
if(funny === 'third') {
        ...
        .setThumbnail(client.user.displayAvatarURL())
        .addField("Information Commands [ 6 ]","`help, invite, ping, node, stats, uptime`")
          .addField("Utility Commands [ 7 ]","`serverinfo, servericon, avatar, emojilist, firstmsg, membercount, list-roles`")
